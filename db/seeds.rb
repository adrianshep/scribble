...
comment1 = Comment.create(title: "long-winded", username: "Norman Mailer", text:  created_at: Date.current, post_id: 1)
comment2 = Comment.create(title: "look who's talking", username: "Ernie Papa Hemingway", text:  created_at: Date.current, post_id: 1)
