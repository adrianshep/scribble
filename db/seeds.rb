...
comment1 = Comment.create(title: "long-winded", username: "Norman Mailer", text: "i found it too long and too boring and a damned nuiscance to read", created_at: Date.current, post_id: 1)
comment2 = Comment.create(title: "look who's talking", username: "Ernie Papa Hemingway", text: "i called your first novel poorly wrapped cheese, you pompous...", created_at: Date.current, post_id: 1)
comment3 = Comment.create(title: "the big TO", username: "Ernie Papa Hemingway", text: "Toronto is damn fine city in which to set a novel. Cuba could've figured in the story.", created_at: Date.current, post_id: 2)
comment4 = Comment.create(title: "fugging?", username: "Jonathan Franzen", text: "It's spelled F-U-C-K, Norm.", created_at: Date.current, post_id: 3)
comment5 = Comment.create(title: "self-referential in the extreme", username: "John Irving", text: "What, you're giving me crap after this exercise in narcissism?", created_at: Date.current, post_id: 4)
comment6 = Comment.create(title: "no takers?", username: "Jonathan Franzen", text: "Why isn't anyone commenting on my posts?", created_at: Date.current, post_id: 5)
